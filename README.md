...
```
npm install @digital-boss/n8n-nodes-aws-lambda-trigger
```
...
AWS Lambda node includes webhook functionality to be called in AWS Lambda functions via POST requests.
...
If you have any issues, please [let us know on GitHub](https://github.com/quansenB/n8n-nodes-dnc-aws-lambda-trigger/issues).
